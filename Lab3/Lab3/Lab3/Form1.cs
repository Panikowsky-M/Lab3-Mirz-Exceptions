...
namespace Lab3
{
    public partial class Form1 : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                res = a & b;
                textBox3.Text = "and(a,b)= " + res.ToString();
            }
            else MessageBox.Show("Операция невыполнима!\r\n"+ "Проверьте а и б", "Отказ !", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                res = a | b;
                textBox3.Text = "or(a,b)= " + res.ToString();
            }
            else MessageBox.Show("Операция неопределена!\r\n" + "Проверьте аргументы", "Отказ !", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            {
                res = a ^ b;
                textBox3.Text = "Xor(a,b)= " + res.ToString();
            }
            else MessageBox.Show("Вызов исключения!\r\n" + "Проверьте поля ввода !", "Отказ !", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            {
                res = ~a+ ~b;
                textBox3.Text = "inv(a,b)= " + res.ToString();
            }
            else MessageBox.Show("Вызов исключения!\r\n" + "Проверьте поля ввода !", "Отказ !", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
